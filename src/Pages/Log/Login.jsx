...
const Login = () => {
    ...
    const handleLogin = (e) => {
        ...
        singIn(email, password)
            .then(result => navLink(location.state||'/') )
            ...
            <div className="w-full max-w-md p-8 space-y-3 bg-[#40F8FF] text-black shadow-2xl shadow-blue-700">
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input  onBlur={handleValid} type="text" name="captcha" placeholder="Confirm that you are not robot" className="w-full text-black px-4 py-3 rounded-md dark:text-gray-800 focus:dark:border-violet-600" />
                    </div>

                    <div>
                        <button type='submit' disabled={disable} className='btn btn-error btn-block'>submit</button>
                    </div>
                </form>
